...
CREATE TABLE "VestingSchedule" (
    ...
    "totalAmountWei" TEXT NOT NULL,
    "releasedAmountWei" TEXT NOT NULL DEFAULT '0',
    "startTime" TIMESTAMP(3) NOT NULL,
    "cliffTime" TIMESTAMP(3) NOT NULL,
    "endTime" TIMESTAMP(3) NOT NULL,
    "revoked" BOOLEAN NOT NULL DEFAULT false,
    "revokable" BOOLEAN NOT NULL DEFAULT false,
    "vestingDirty" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "VestingSchedule_vestingDirty_idx" ON "VestingSchedule"("vestingDirty");

-- CreateIndex
CREATE INDEX "VestingSchedule_source_idx" ON "VestingSchedule"("source");

-- CreateIndex
CREATE INDEX "VestingRelease_vestingScheduleId_idx" ON "VestingRelease"("vestingScheduleId");
...
-- AddForeignKey
ALTER TABLE "VestingRelease" ADD CONSTRAINT "VestingRelease_vestingScheduleId_fkey" FOREIGN KEY ("vestingScheduleId") REFERENCES "VestingSchedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;
